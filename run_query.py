...
if __name__ == "__main__":
    run_queries("logistics.db", "data/query1.sql")
    run_queries("logistics.db", "data/query2.sql")
    run_queries("logistics.db", "data/query3.sql")
    run_queries("logistics.db", "data/test.sql")
